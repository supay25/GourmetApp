...
export default function AdminConfiguracion() {
  ...
  const guardar = () => {
    // Mock — cuando el backend esté listo, hacer PUT /api/config
    ...
    <AdminLayout>
      <div style={{ padding: '36px 40px', maxWidth: 640 }}>
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <h1 style={{ fontFamily: 'Montserrat', fontWeight: 900, fontSize: '1.8rem', letterSpacing: '-0.03em', color: '#eeeeee' }}>Configuración</h1>
        </div>
        ...
        {campos.map(({ section, fields }) => (
          <div key={section} style={{
            ...
            <p style={{
              ...
              color: 'rgba(238,238,238,0.3)', marginBottom: 20,
            }}>{section}</p>
        ...
        <p style={{
          ...
          color: 'rgba(238,238,238,0.2)', marginTop: 16,
        }}>
