...
export default function Carrito() {
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          >
            CARRITO
            <br />
            <span style={{ color: "#f0493f" }}>DE COMPRAS</span>
          </h1>
        </div>
          ...
          <div className="carrito-items">
            {items.map((item) => (
              <div
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.borderColor = "rgba(240,73,63,0.2)")
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.borderColor = "rgba(238,238,238,0.05)")
                }
              >
                {/* Imagen */}
                <div
                ...
                >
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.target.style.borderColor = "#f0493f";
                      e.target.style.color = "#f0493f";
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.borderColor = "rgba(238,238,238,0.2)";
                ...
                <button
                  ...
                  onMouseLeave={(e) =>
                    (e.target.style.color = "rgba(238,238,238,0.2)")
                  }
                >
                  ✕
                </button>
  ...
  @media (max-width: 480px) {
    ...
    .carrito-items > div > div:first-child {
      width: 48px !important;
      height: 48px !important;
    }
    .carrito-items > div > div:first-child img {
      width: 36px !important;
      height: 36px !important;
    }
    .carrito-items > div > span {
