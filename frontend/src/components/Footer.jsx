      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ maxWidth: 280 }}>
            ...
            >
              Productos artesanales elaborados con ingredientes frescos, hechos
              con pasión en Costa Rica.
            </p>
            <p
              style={{
          ...
          <div>
            ...
            {[
              ...
              <Link
                ...
                onMouseLeave={(e) =>
                  (e.target.style.color = "rgba(238,238,238,0.5)")
                }
              >
                {link.label}
              </Link>
          ...
          <div>
            ...
            <a
              href="mailto:gourmettocr@gmail.com"
              style={{
                display: "flex",
                alignItems: "center",
                gap: 8,
            ...
            <a
              href="https://wa.me/50663818443?text=%C2%A1Hola%2C%20Quiero%20informaci%C3%B3n%20acerca%20de%20Gourmetto!"
              target="_blank"
            ...
            <div style={{ display: "flex", gap: 10 }}>
              {[
                {
                  icon: "fa-instagram",
                  url: "https://instagram.com/gourmetto.cr",
                  label: "Instagram",
                },
                {
                  icon: "fa-facebook-f",
                  url: "https://www.facebook.com/profile.php?id=61558109290511",
                  label: "Facebook",
                },
                {
                  icon: "fa-whatsapp",
                  url: "https://wa.me/50663818443?text=%C2%A1Hola%2C%20Quiero%20informaci%C3%B3n%20acerca%20de%20Gourmetto!",
                  label: "WhatsApp",
                },
              ].map((red) => (
                <a
        ...
        >
          ...
          >
            © {new Date().getFullYear()} Gourmetto. Todos los derechos
            reservados.
          </p>
          <p
            style={{
